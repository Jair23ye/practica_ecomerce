...
<div class="max-w-2xl mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold text-gray-800 mb-6">Nueva Categoría</h1>
    ...
    <form method="POST" action="{{ route('categorias.store') }}" class="bg-white rounded-xl shadow p-8 space-y-5">
        @csrf
        <div>
